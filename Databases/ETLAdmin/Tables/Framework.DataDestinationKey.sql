CREATE TABLE Framework.DataDestinationKey (
    ...
    CONSTRAINT FK_Framework#DataDestinationKey_Framework#DataDestinationTable FOREIGN KEY (DatabaseTableID) REFERENCES Framework.DataDestinationTable (DatabaseTableID)
);
GO
